...
},
{
  ...
  "number": "3.2.1",
  "title": "",
  "body": "  Kita akan mulai dengan mempertimbangkan situasi yang lebih familiar; yaitu, fungsi , yang mengambil bilangan real sebagai input dan menghasilkan kuadratnya sebagai output-nya.  Berapakah nilai dari ?  Dapatkah kita menyelesaikan persamaan ? Jika ya, apakah solusinya tunggal?  Dapatkah kita menyelesaikan persamaan ? Jika ya, apakah solusinya tunggal?  Sketsa grafik fungsi dalam      Gambarkan grafik fungsi di atas.    Kita sekarang akan mempertimbangkan fungsi yang memiliki bentuk . Gambarkan grafik fungsi di sebelah kiri dalam .      Grafik fungsi dan .    Gambarkan grafik fungsi di sebelah kanan .  Ingat bahwa mengomposisikan dua fungsi berarti kita menggunakan output dari satu fungsi sebagai input ke fungsi lain; yaitu, . Fungsi apa yang dihasilkan dari mengomposisikan ?      Kita menemukan .  Jika , maka sehingga tidak ada solusi tunggal.  Tidak ada solusi untuk persamaan .       Grafik ditunjukkan di sebelah kiri di bawah.      Grafik ditunjukkan di sebelah kanan di atas.  Dengan mengomposisikan fungsi-fungsi, kita menemukan bahwa . Kita melihat bahwa komposisi adalah fungsi linear baru yang kemiringannya diperoleh dengan mengalikan kemiringan dari dan .    "
},
{
